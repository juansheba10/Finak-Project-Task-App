<template>
  <div class="flex flex-col">
    ...
    <div class="flex justify-center">
      <textarea
        class="block p-4 w-1/2 h-20 text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 shadow-md"
        cols="28"
        rows="5"
        v-model="taskDesc"
        type="text"
